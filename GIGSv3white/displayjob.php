...
<body>
    ...
    <div class="container">
        <!--
        <a href="addform.php"><button id="addgig">Add Gig</button></a>
        <a href="http://localhost/GIGSv3white_3/GIGSv3white/newchat/indexchat.html" target="_blank"><button id="chat">Chat</button></a>
        <a href="http://localhost/GIGSv3white_3/GIGSv3white/GIGSv3white/reviews.php" target="_blank"><button id="review">Review</button></a>
        -->
        <?php
